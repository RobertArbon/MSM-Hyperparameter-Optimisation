...
\subsection{Bayesian optimisation may optimise different processes}\label{sec:bayes}
...
\begin{enumerate}
    ...
    \item Bayesian optimisation of $t_2$ or VAMP$_{eq}$ can be used to optimise hyperparameters but the eigenvectors must be inspected for  consistency.  
\end{enumerate}
