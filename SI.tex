...
\begin{enumerate}
    \item Chignolin 1 - best from random sampling
    \item Chignolin 2 - best from Bayesian optimisation
    \item BBA 1 - best overall from random sampling. Shows misfolding as t2 (folded -> misfolded)
    \item BBA 2 - best dihedrals from random sampling  
    \item BBA 3 - best distances from random sampling
    \item BBA 4 - best from Bayesian optimisaiton (of just the logit(dist)?)
    \item BBA 5 - second best overall.   
\end{enumerate}
...
\begin{table}
    ...
    \toprule
    Protein & No. & \thead{Lag time \\ (\si{\nano\second})} & Feature & \thead{\# cluster \\ centers} & \thead{TICA lag \\ (\si{\nano\second})} & TICA dim. & \thead{Optimisation \\ method } & \thead{\# initialization \\ trials} & \thead{\# optimisation \\ trials }& Objective & $t_2$ \\
    \midrule
     Chignolin    & 1 & 31 & dist. & 488 & 71 & 15 & Random & NA & 140 & $t_{2}$ & \makecell[tc]{\SI{379.4}{\nano\second}\\ (\SIrange{296.5}{469.7}{\nano\second})}\\
     Chignolin    & 2 & 31 & dist. & 469 & 3 & 15 & Bayesian & 131 & 100 & $t_{2}$ & \SI{388.2}{\nano\second}  \\
     BBA    & 1 & 41 & \makecell[tl]{logit(dist.)\\( 2.2, 0.61)} & 471 & 60 & 20 & Random & NA & 140 & $t_{2}$ & \makecell[tc]{\SI{20.4}{\micro\second} \\ (\SIrange{2.3}{176.2}{\micro\second})}\\
     BBA    & 2 & 41 & dihed. & 471 & 99 & 13 & Random & NA & 140 & $t_{2}$ & \makecell[tc]{2.1 \\ (1.8, 20.6)} \\
     BBA    & 3 & 41 & dist. & 485 & 52 & 19 & Random & NA & 140 & $t_{2}$ & \makecell[tc]{6.6 \\ (2.4, 150.4)}  \\
     BBA    & 4 & 41 & \makecell[tl]{logit(dist.,)\\(7.7, 0.33)} & 444 & 53 & 20 & Bayesian & 136 & 100 & $t_{2}$ & \SI{46.6}{\micro\second} \\
     BBA    & 5 & 41 & \makecell[tl]{logit(dist.) \\(8.0, 2.9)} & 289 & 67 & 18 & Random & NA & 140 & $t_{2}$ & \makecell[tc]{\SI{9.7}{\micro\second}\\ (\SIrange{2.1}{18.9}{\micro\second})}  \\
    \bottomrule
    \end{tabularx}
...
\begin{figure}[h]
    \centering
    \includegraphics[height=0.25\textheight]{SI_figures/CLN_218_its.pdf}
    \caption{\textsc{Chignolin, model 2 validation}. Panel (a) shows the implied timescales as a function of the lag-time.}
...
\begin{figure}[h]
    \centering
    \includegraphics[height=0.25\textheight]{missing.pdf}
    \caption{\textsc{BBA, model 1 validation}.  Panel (a) shows the implied timescales as a function of the lag-time. }
...
\begin{figure}[h]
    ...
    \caption{\textsc{BBA,  model 2 free energy surface}. See the caption for figure \ref{si_fig:BBA_24_1}.}
...
\begin{figure}[h]
    \centering
    \includegraphics[height=0.25\textheight]{SI_figures/BBA_227_its.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{SI_figures/BBA_124_SI1.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\columnwidth]{SI_figures/BBA_124_SI2.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[height=0.25\textheight]{SI_figures/BBA_124_its.pdf}
